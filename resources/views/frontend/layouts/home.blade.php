...
<section class="women-banner spad">
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-3">
                <div class="product-large set-bg" data-setbg="{{url('frontend/img/sitting-on-roof.jpg')}}">
                    <h2>Women’s</h2>
        ...
        <div class="row">
            <div class="col-lg-8">
                ...
                <div class="product-slider owl-carousel">
                    <div class="product-item">
                        <div class="pi-pic">
                            <img src="img/products/xman-1.jpg.pagespeed.ic.DPWA1LC_uk.webp" alt=""
                                data-pagespeed-url-hash="1647926951"
                                onload="pagespeed.CriticalImages.checkImageForCriticality(this);">
                    ...
                    <div class="product-item">
                        <div class="pi-pic">
                            <img src="img/products/xman-2.jpg.pagespeed.ic.MljB6PGycq.webp" alt=""
                                data-pagespeed-url-hash="1942426872"
                                onload="pagespeed.CriticalImages.checkImageForCriticality(this);">
                            <div class="icon">
                                <i class="icon_heart_alt"></i>
                            </div>
                    ...
                    <div class="product-item">
                        <div class="pi-pic">
                            <img src="img/products/xman-3.jpg.pagespeed.ic.CK7sqeQEq-.webp" alt=""
                                data-pagespeed-url-hash="2236926793"
                                onload="pagespeed.CriticalImages.checkImageForCriticality(this);">
                            <div class="icon">
                                <i class="icon_heart_alt"></i>
                            </div>
                    ...
                    <div class="product-item">
                        <div class="pi-pic">
                            <img src="img/products/xman-4.jpg.pagespeed.ic.bY7ZLLeiAg.webp" alt=""
                                data-pagespeed-url-hash="2531426714"
                                onload="pagespeed.CriticalImages.checkImageForCriticality(this);">
                            <div class="icon">
                                <i class="icon_heart_alt"></i>
                            </div>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="single-latest-blog">
                    <img src="img/xlatest-1.jpg.pagespeed.ic.NWH-yJ0uMS.webp" alt=""
                        data-pagespeed-url-hash="2639207979"
                        onload="pagespeed.CriticalImages.checkImageForCriticality(this);">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="single-latest-blog">
                    <img src="img/xlatest-2.jpg.pagespeed.ic.BHI3A1KcBK.webp" alt=""
                        data-pagespeed-url-hash="2933707900"
                        onload="pagespeed.CriticalImages.checkImageForCriticality(this);">
                    <div class="latest-text">
                        <div class="tag-list">
                            <div class="tag-item">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="single-latest-blog">
                    <img src="img/xlatest-3.jpg.pagespeed.ic.oSrw_eGSen.webp" alt=""
                        data-pagespeed-url-hash="3228207821"
                        onload="pagespeed.CriticalImages.checkImageForCriticality(this);">
                    <div class="latest-text">
                        <div class="tag-list">
                            <div class="tag-item">
                    ...
                    <div class="single-benefit">
                        <div class="sb-icon">
                            <img src="img/xicon-1.png.pagespeed.ic.1MBleL9YE6.webp" alt=""
                                data-pagespeed-url-hash="157847617"
                                onload="pagespeed.CriticalImages.checkImageForCriticality(this);">
                        </div>
                        <div class="sb-text">
                            <h6>Free Shipping</h6>
                    ...
                    <div class="single-benefit">
                        <div class="sb-icon">
                            <img src="img/xicon-2.png.pagespeed.ic.GdrReyKBWV.webp" alt=""
                                data-pagespeed-url-hash="452347538"
                                onload="pagespeed.CriticalImages.checkImageForCriticality(this);">
                        </div>
                        <div class="sb-text">
            ...
            <div class="logo-item">
                <div class="tablecell-inner">
                    <img src="img/logo-carousel/xlogo-1.png.pagespeed.ic.hHd3Ak60Md.webp" alt=""
                        data-pagespeed-url-hash="1295928952"
                        onload="pagespeed.CriticalImages.checkImageForCriticality(this);">
                </div>
            </div>
            <div class="logo-item">
                <div class="tablecell-inner">
                    <img src="img/logo-carousel/xlogo-2.png.pagespeed.ic.5O9ErUCggC.webp" alt=""
                        data-pagespeed-url-hash="1590428873"
                        onload="pagespeed.CriticalImages.checkImageForCriticality(this);">
                </div>
            </div>
            <div class="logo-item">
                <div class="tablecell-inner">
                    <img src="img/logo-carousel/xlogo-3.png.pagespeed.ic.fi4-kfQW7Q.webp" alt=""
                        data-pagespeed-url-hash="1884928794"
                        onload="pagespeed.CriticalImages.checkImageForCriticality(this);">
                </div>
            </div>
            <div class="logo-item">
                <div class="tablecell-inner">
                    <img src="img/logo-carousel/xlogo-4.png.pagespeed.ic.74BR0xCCyN.webp" alt=""
                        data-pagespeed-url-hash="2179428715"
                        onload="pagespeed.CriticalImages.checkImageForCriticality(this);">
                </div>
            </div>
            <div class="logo-item">
                <div class="tablecell-inner">
                    <img src="img/logo-carousel/xlogo-5.png.pagespeed.ic.XZwig1FcCp.webp" alt=""
                        data-pagespeed-url-hash="2473928636"
                        onload="pagespeed.CriticalImages.checkImageForCriticality(this);">
                </div>
            </div>
        </div>
